...
export const metadata = { title: `Envios y entregas · ${STORE_NAME}` };
  ...
  return (
    ...
    >
      ...
      <p>
        ...
        la fecha y el horario de entrega, asi como el medio de pago.
      </p>

      <h2>Zonas de entrega</h2>
      <p>
        Realizamos entregas en nuestra zona de cobertura habitual. Si tu
        direccion esta fuera de ella, escribenos y buscaremos una alternativa.
      </p>

      <h2>Tiempos</h2>
      <p>
        Los tiempos de entrega dependen de la disponibilidad del producto y de
        tu ubicacion. Te informaremos un plazo estimado al confirmar el pedido.
      </p>

      <h2>Costos</h2>
      <p>
        El costo de despacho, si aplica, se acuerda al momento de coordinar la
        entrega segun la zona.
      </p>

      <p>
        <strong>Nota:</strong> revisa y ajusta esta informacion con tus datos
